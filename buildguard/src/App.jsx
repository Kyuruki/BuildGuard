...
import { ROUTE_TITLES, SITE } from "./content.js";
...
export default function App() {
  ...
  // Set the document title on every route. On client-side NAVIGATIONS (not the
  // initial load), also announce the page, move focus to <main>, and reset scroll —
  // skipping this on first mount keeps the skip link and header reachable on load.
  useEffect(() => {
    const title = ROUTE_TITLES[location.pathname] || `${SITE.name}`;
